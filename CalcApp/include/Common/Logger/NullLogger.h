...
{
public:
    explicit NullLogger(LogLevel level, QObject *parent = nullptr);
    ...
    virtual void WriteInfoFormat(QString const &message, ...) override {}
    virtual void WriteInfoFormat(LoggerCategory const &category, QString const &message, ...) override {}
    ...
    virtual void WriteWarningFormat(QString const &message, ...) override {}
    virtual void WriteWarningFormat(LoggerCategory const &category, QString const &message, ...) override {}
    ...
    virtual void WriteErrorFormat(QString const &message, ...) override {}
    virtual void WriteErrorFormat(LoggerCategory const &category, QString const &message, ...) override {}
    ...
    virtual void WriteCriticalFormat(QString const &message, ...) override {}
    virtual void WriteCriticalFormat(LoggerCategory const &category, QString const &message, ...) override {}
};

NullLogger::NullLogger(LogLevel level, QObject *parent = nullptr) : ILogger(level, parent)
{
}
